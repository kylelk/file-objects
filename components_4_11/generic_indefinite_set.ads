...
--
--  This package is similar to Generic_Set,  but also allows  indefinite
--  object type as the actual formal parameter.
...
generic
   ...
   with function "=" (Left, Right : Object_Type) return Boolean is <>;
package Generic_Indefinite_Set is
   pragma Preelaborate (Generic_Indefinite_Set);
